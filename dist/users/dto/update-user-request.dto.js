...
class UpdateUserRequestDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { updateUserDto: { required: true, type: () => require("./update-users.dto").UpdateUserDto }, id: { required: true, type: () => String }, file: { required: true, type: () => Object } };
    }
}
__decorate([
...
], UpdateUserRequestDto.prototype, "file", void 0);
