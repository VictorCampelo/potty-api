...
export class AuthController {
  ...
  async facebookRedirect(@Req() req, @Res() res: Response): Promise<any> {
    ...
    if (typeof url !== 'string') {
      res.redirect(
        `https://www.potty.com.br/cadastro?email=${url.email}&firstName=${url.firstName}&lastName=${url.lastName}&facebookId=${url.id}`,
      );
    } else {
      res.redirect(url);
    }
  ...
  async googleRedirect(@Req() req, @Res() res: Response) {
    ...
    if (typeof url !== 'string') {
      res.redirect(
        `https://www.potty.com.br/cadastro?email=${url.email}&firstName=${url.firstName}&lastName=${url.lastName}&googleId=${url.id}`,
      );
    } else {
      res.redirect(url);
    }
