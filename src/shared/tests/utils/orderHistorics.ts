...
export default class OrderHistoricsUtil {
  ...
  static giveMeAValidOrderHistoric(id = '1'): OrderHistoric {
    ...
    orderHistoric.product = ProductUtils.giveMeAValidProduct(id, '1', 10, 10, 'produto teste');
    orderHistoric.productId = ProductUtils.giveMeAValidProduct(id, '1', 10, 10, 'produto teste').id;
